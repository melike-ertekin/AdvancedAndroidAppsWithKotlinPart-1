...
class Step8Activity : AppCompatActivity() {
    ...
    * It will not be resized, but just moved up. If you have constraints to the top of the MotionLayout, they will be offscreen at the end of the animation.
    * To work with AppBarLayout ensure end constraints are anchored to the bottom of the parent.
    * */
